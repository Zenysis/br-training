...
DIMENSION_CATEGORIES = [
    ...
    (
        ...
        [
            ...
            Dimension.CAUSES_TITLE,
            Dimension.CAUSES_PARENT,
            Dimension.CAUSES_CATEGORY_1,
            Dimension.CAUSES_CATEGORY_2,
            Dimension.CAUSES_CATEGORY_3,
            Dimension.CAUSES_CATEGORY_4,
