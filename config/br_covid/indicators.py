from config.br_covid.calculated_indicators import CALCULATED_INDICATOR_GROUPS
from config.br_covid.indicator_groups.demo.demo import DEMO_GROUPS
from data.aqt_datasources import build_data_source

GROUP_DEFINITIONS = []
GROUP_DEFINITIONS.extend(DEMO_GROUPS)
GROUP_DEFINITIONS.extend(CALCULATED_INDICATOR_GROUPS)
