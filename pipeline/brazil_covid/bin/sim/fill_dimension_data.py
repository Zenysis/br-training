...
def main():
    ...
    out_file_pattern = FilePattern(Flags.ARGS.output_file_pattern)
    in_file_pattern = FilePattern(Flags.ARGS.input_file_pattern)
    with ShardReader(in_file_pattern, LZ4Reader) as input_file, ShardWriter(
        out_file_pattern, Flags.ARGS.shard_size, PigzWriter
        ...
        DruidWriter.run(
            ...
            bool(Flags.ARGS.track_failed_matches),
        )
    return 0
